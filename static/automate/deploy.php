<?php
	...
	exec('cd /srv/users/serverpilot/apps/' . $app . '/build && git fetch --all && git reset --hard origin/master && /usr/local/bin/hugo && cp -r /srv/users/serverpilot/apps/' . $app . '/build/public/. /srv/users/serverpilot/apps/' . $app . '/public && rm -r /srv/users/serverpilot/apps/' . $app . '/build/public | at now +1 minute');
